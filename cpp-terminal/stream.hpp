...
class TIstream : public std::basic_istream<char, std::char_traits<char>>
{
public:
...
public:
  ...
  TOstream& operator<<(std::ostream& (*t)(std::ostream&))override
  {
    m_stream << t;
    return *this;
  }*/
